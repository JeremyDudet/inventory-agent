...
describe("ConfirmationService", () => {
  ...
  describe("determineConfirmationType", () => {
    ...
    it("should require confirmation for similar items", () => {
      ...
      const calculateSimilaritySpy = jest
        .spyOn(confirmationService as any, "calculateSimilarity")
        .mockReturnValue(0.8);
  ...
  describe("isLargeQuantityChange", () => {
    it("should identify large additions", () => {
      const result = (confirmationService as any).isLargeQuantityChange(
        "add",
        60,
        100
      );
  ...
  describe("processVoiceCorrection", () => {
    it("should process simple confirmation", () => {
      ...
      const result = confirmationService.processVoiceCorrection(
        originalCommand,
        "yes"
      );
